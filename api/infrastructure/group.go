...
func (r *GroupRepository) IsGroupMember(ctx context.Context, userID string, groupID string, accessToken string) (bool, error) {
	values := url.Values{}
	...
	if res.StatusCode >= http.StatusBadRequest {
		return false, groupRPCError(resBody)
	}
...
func (r *GroupRepository) setAuthHeaders(req *http.Request, accessToken string) {
